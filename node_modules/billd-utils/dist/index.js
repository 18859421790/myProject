(function (global, factory) {
  ...
  var isSymbol$3 = USE_SYMBOL_AS_UID$1 ? function (it) {
    ...
    return isCallable$h($Symbol) && isPrototypeOf$b($Symbol.prototype, $Object$3(it));
  };
  ...
  var uid$3 = function (key) {
    return 'Symbol(' + (key === undefined ? '' : key) + ')_' + toString$7(++id$2 + postfix, 36);
  };
  ...
  */
  ...
  var setToStringTag$6 = function (it, TAG, STATIC, SET_METHOD) {
    if (it) {
      ...
      if (SET_METHOD && !TO_STRING_TAG_SUPPORT) {
        createNonEnumerableProperty$4(target, 'toString', toString$6);
      }
    }
  };
  ...
  var method$6 = filter$2;

  var ArrayPrototype$6 = Array.prototype;

  var filter$1 = function (it) {
    var own = it.filter;
    return it === ArrayPrototype$6 || (isPrototypeOf$8(ArrayPrototype$6, it) && own === ArrayPrototype$6.filter) ? method$6 : own;
  };
  ...
  // `Array.prototype.indexOf` method
  // https://tc39.es/ecma262/#sec-array.prototype.indexof
  $$k({ target: 'Array', proto: true, forced: NEGATIVE_ZERO || !STRICT_METHOD }, {
  ...
  var method$5 = indexOf$2;

  var ArrayPrototype$5 = Array.prototype;

  var indexOf$1 = function (it) {
    var own = it.indexOf;
    return it === ArrayPrototype$5 || (isPrototypeOf$7(ArrayPrototype$5, it) && own === ArrayPrototype$5.indexOf) ? method$5 : own;
  };
  ...
  var includes$3 = entryVirtual$6('Array').includes;
  ...
  var includes$2 = entryVirtual$5('String').includes;
  ...
  var includes$1 = function (it) {
    var own = it.includes;
    if (it === ArrayPrototype$4 || (isPrototypeOf$6(ArrayPrototype$4, it) && own === ArrayPrototype$4.includes)) return arrayMethod;
    if (typeof it == 'string' || it === StringPrototype$1 || (isPrototypeOf$6(StringPrototype$1, it) && own === StringPrototype$1.includes)) {
      return stringMethod;
    } return own;
  };
  ...
  $$h({ target: 'Array', proto: true, arity: 1, forced: FORCED }, {
  ...
  var method$4 = concat$4;

  var ArrayPrototype$3 = Array.prototype;

  var concat$3 = function (it) {
    var own = it.concat;
    return it === ArrayPrototype$3 || (isPrototypeOf$5(ArrayPrototype$3, it) && own === ArrayPrototype$3.concat) ? method$4 : own;
  };
  ...
  var slice$2 = entryVirtual$3('Array').slice;
  ...
  var slice$1 = function (it) {
    var own = it.slice;
    return it === ArrayPrototype$2 || (isPrototypeOf$4(ArrayPrototype$2, it) && own === ArrayPrototype$2.slice) ? method$3 : own;
  };
  ...
  var repeat$1 = function (it) {
    ...
    return typeof it == 'string' || it === StringPrototype
      || (isPrototypeOf$3(StringPrototype, it) && own === StringPrototype.repeat) ? method$2 : own;
  };

  var parent$7 = repeat$1;
  ...
  $$7({ target: 'Promise', stat: true, forced: IS_PURE$1  }, {
  ...
  var promise$1 = path$4.Promise;

  var parent$6 = promise$1;


  var promise = parent$6;
  ...
  var filterObj = function filterObj(obj, keyArr) {
    var res = {};
    _Object$keys(obj).forEach(function (item) {
      if (!_includesInstanceProperty(keyArr).call(keyArr, item)) {
        res[item] = obj[item];
      }
    });
    return res;
  ...
  function getStars(count) {
    var _context;
    return _repeatInstanceProperty(_context = "*").call(_context, count);
  }
  ...
  var generateStyle = function generateStyle(styleObj) {
    ...
    function getStyleVal(obj) {
      ...
      _Object$keys(obj).forEach(function (key) {
        var _context2;
        str += _concatInstanceProperty(_context2 = "".concat(key, ":")).call(_context2, obj[key], ";");
      });
      return str;
    }
  ...
  var deleteUseLessObjectKey = function deleteUseLessObjectKey(obj) {
    _Object$keys(obj).forEach(function (key) {
      var _context3;
      if (_includesInstanceProperty(_context3 = [null, void 0, NaN, ""]).call(_context3, obj[key])) {
        delete obj[key];
      }
    });
    return obj;
  ...
  exports.isPureNumber = isPureNumber;

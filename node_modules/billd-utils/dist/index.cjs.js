...
var filterObj = function filterObj(obj, keyArr) {
  var res = {};
  _Object$keys__default["default"](obj).forEach(function (item) {
    if (!_includesInstanceProperty__default["default"](keyArr).call(keyArr, item)) {
      res[item] = obj[item];
    }
  });
  return res;
...
function getStars(count) {
  var _context;
  return _repeatInstanceProperty__default["default"](_context = "*").call(_context, count);
}
...
var generateStyle = function generateStyle(styleObj) {
  ...
  function getStyleVal(obj) {
    ...
    _Object$keys__default["default"](obj).forEach(function (key) {
      var _context2;
      str += _concatInstanceProperty__default["default"](_context2 = "".concat(key, ":")).call(_context2, obj[key], ";");
    });
    return str;
  }
...
var deleteUseLessObjectKey = function deleteUseLessObjectKey(obj) {
  _Object$keys__default["default"](obj).forEach(function (key) {
    var _context3;
    if (_includesInstanceProperty__default["default"](_context3 = [null, void 0, NaN, ""]).call(_context3, obj[key])) {
      delete obj[key];
    }
  });
  return obj;

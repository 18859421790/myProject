 ...
 * @return {*}
 */
declare const filterObj: (obj: Record<string, any>, keyArr: string[]) => Record<string, any>;
/**
 * @description: 返回*
 * @example
 ...
 * @return {*}
 */
declare function getStars(count: number): string;
/**
 * @description: 字符串编码
 * @param {string} str
 * @return {*}
...
declare const utils_filterObj: typeof filterObj;
declare const utils_getStars: typeof getStars;
...
declare namespace utils {
  export {
    ...
    utils_filterObj as filterObj,
    utils_getStars as getStars,
